...
namespace ControlIDMvc.Controllers
{
    ...
    public class PlanDeCuentasController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Index(PlanCuentaListaDto planCuentaListaDto)
        {
            planCuentaListaDto.planCuentaGrupos = await this._planCuentasGrupoQuery.GetAll();
